...
function SimpleForm() {
  ...
  */
  ...
  const validate = (event) => {
    ...
    //There's a need to put [] here to get the actual value of the variable name.
...
//npx serve helps you serve a static site, single page application or just a static file (no matter if on your device or on the local network). 